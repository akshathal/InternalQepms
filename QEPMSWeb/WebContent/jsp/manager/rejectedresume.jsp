...
<%
 	...
 	List<ResumeDTO> resumelist = (List<ResumeDTO>)restUtil.getData(QEPMSWebConstants.Manager.EMPLOYEE_MASTER_WS_PAGE_PATH+"?managerApprovalStatus=REJECTED&reportingManager="+reportingManager, ResumeDTOList.class);
 	pageContext.setAttribute("resumelist", resumelist); */
 	
 	//Added By Chethana
 	 	String reportingManagerEmail = user.getEmployeEmail();
 	System.out.println("reportingManagerEmail="+reportingManagerEmail);
 	 	...
 	 	System.out.println("Rejected REsume .jsp returning resumelist :::"+resumelist);
 	 	pageContext.setAttribute("resumelist", resumelist);
